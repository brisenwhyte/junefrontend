        ...
        <div className="relative z-10 flex min-h-screen flex-col">
          <header className="flex items-center justify-between px-8 py-6">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xl font-bold tracking-wider text-white">JUNE</span>
            </div>
            ...
            <div className="grid w-full gap-12 lg:grid-cols-2 lg:gap-24">
              <div className="flex flex-col justify-center">
                ...
                <p className="mb-4 text-lg font-satoshi text-bold tracking-wide text-white lg:text-xl">
                  JUNE STANDS FOR A NEW KIND OF MONEY — OPEN,<br />
                  SOVEREIGN, AND HUMAN.
                </p>
      ...
      <section className="relative min-h-screen overflow-hidden bg-[#0015cc]">
        <div className="relative z-10 flex min-h-screen flex-col">
          ...
          <div className="flex flex-1 items-center px-8 lg:px-16">
            <div className="grid w-full gap-12 lg:grid-cols-2 lg:gap-24">
              <div className="flex flex-col justify-center">
                <h1 className="mb-8 text-6xl font-light leading-tight text-white lg:text-7xl">
                  Moneys new<br />Season
                </h1>
                <div className="mb-8 h-px w-full max-w-md bg-white/40" />
                <p className="mb-4 text-lg font-light tracking-wide text-white lg:text-xl">
                  JUNE STANDS FOR A NEW KIND OF MONEY — OPEN,<br />
                  SOVEREIGN, AND HUMAN.
                </p>
      ...
      <section className="relative min-h-screen overflow-hidden bg-gradient-to-br from-[#004499] via-[#5588aa] to-[#ff7733]">
        ...
        <div className="relative z-10 flex min-h-screen flex-col">
          ...
          <div className="flex flex-1 flex-col items-center justify-center px-8 text-center">
            <h1 className="mb-12 text-5xl font-light leading-tight text-white lg:text-6xl">
              Where your money grows.
            </h1>

            <form onSubmit={handleSubmit} className="mb-12 flex w-full max-w-xl gap-4">
              <Input
                type="email"
            ...
            <div className="max-w-2xl space-y-4">
              <p className="text-lg font-light tracking-wide text-white lg:text-xl">
                JUNE STANDS FOR A NEW KIND OF MONEY — ONE WHERE<br />
                YOU'RE IN CONTROL.
              </p>
              <p className="text-lg font-light tracking-wide text-white lg:text-xl">
                STEP INTO THE LIGHT — SIGN UP FOR EARLY ACCESS.
